...
/** Utility functions used by the Zenyx Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "zenyx:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load zenyx specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a zenyx specific theme is activated (light/dark).*/
