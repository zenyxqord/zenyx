...
//
//     src/qt/test/test_zenyx-qt -platform xcb      # Linux
//     src/qt/test/test_zenyx-qt -platform windows  # Windows
//     src/qt/test/test_zenyx-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: zenyx:")) != -1);
