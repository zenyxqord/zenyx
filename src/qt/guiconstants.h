...
/* ZenyxGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* ZenyxGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Zenyx"
#define QAPP_ORG_DOMAIN "zenyx.org"
#define QAPP_APP_NAME_DEFAULT "Zenyx-Qt"
#define QAPP_APP_NAME_TESTNET "Zenyx-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Zenyx-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Zenyx-Qt-regtest"
