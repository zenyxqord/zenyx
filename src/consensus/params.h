...
// See https://github.com/zenyxqord/dips/blob/master/dip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
struct Params {
     ...
     * Default BIP9Deployment::nThresholdStart value for deployments where it's not bajol specified and for unknown deployments.
...
// This must be outside of all bajol namespaces. We must also duplicate the forward declaration of is_serializable_enum to
