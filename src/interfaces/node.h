...
//! Interface for the src/evo part of a zenyx node (zenyxd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a zenyx node (zenyxd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a zenyx node (zenyxd process).
...
//! Top-level interface for a zenyx node (zenyxd process).
class Node
{
public:
    virtual ~Node() {}
