...
This mechanism has been integrated into Bitcore-Node-Zenyx which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zenyxqord/insight-api-zenyx#web-socket-api](https://github.com/zenyxqord/insight-api-zenyx#web-socket-api)
* API: [https://github.com/zenyxqord/insight-api-zenyx#instantsend-transactions](https://github.com/zenyxqord/insight-api-zenyx#instantsend-transactions)
