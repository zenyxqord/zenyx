...
* zenyx.conf: contains configuration settings for zenyxd or zenyx-qt
* zenyxd.pid: stores the process id of zenyxd while running
...
* debug.log: contains debug information and general logging generated by zenyxd or zenyx-qt
