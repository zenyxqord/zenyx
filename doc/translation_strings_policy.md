...
This document provides guidelines for internationalization of the Zenyx Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zenyx_en.ts` remains unchanged.
