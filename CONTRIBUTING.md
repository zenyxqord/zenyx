Contributing to Zenyx Core
============================

The Zenyx Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/zenyxqord/zenyx/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Zenyx Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Zenyx
Network Protocol consensus changes.

Whether a pull request is merged into Zenyx Core rests with the project merge
...
Patches that change Zenyx consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zenyx consensus, it must have been
...
The review process is normally fairly responsive on the Zenyx Core repository, however
...
The project leader is the release manager for each Zenyx Core release.
