...
"""Verify that starting zenyxd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zenyxd with -h for help text")
        ...
        self.log.info("Start zenyxd with -version for version information")
