#!/usr/bin/env python3
# Copyright (c) 2015-2020 The Zenyx Core developers
...
class BlockRewardReallocationTest(ZenyxTestFramework):
    def set_test_params(self):
        self.set_zenyx_test_params(2, 1, fast_dip3_enforcement=True)
        self.set_zenyx_dip8_activation(450)
